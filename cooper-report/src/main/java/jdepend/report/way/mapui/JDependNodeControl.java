...
public class JDependNodeControl extends ControlAdapter {
	...
	public void itemEntered(VisualItem item, MouseEvent e) {
		...
		if (item instanceof TableNodeItem && GraphPrinter.getIntance().isPackageTreeVisible()) {
			String itemName = item.getString("label");
			GraphPrinter.getIntance().setPackageTreeFocus(itemName);
		}
	}
	...
	private void showClassList(String source) {
		ClassListDialog d = new ClassListDialog(this.display.getTheElement(source).getComponent());
		d.setModal(true);
		d.setVisible(true);
