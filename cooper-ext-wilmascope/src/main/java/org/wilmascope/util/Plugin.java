...
/**
 * Implement this interface to create plugins that can be managed by a Registry
 * 
 * @author dwyer
 */
public interface Plugin {
	 ...
	 * This string will appear in the Registry Window list so give it a capital
	 * letter and spaces where necessary.
	 * 
	 ...
	 * parameters for your plugin in your constructor and ensure that this
	 * method returns a reference to it.
	 * 
