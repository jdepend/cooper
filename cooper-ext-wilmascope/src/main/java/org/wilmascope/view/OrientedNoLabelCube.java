...
public class OrientedNoLabelCube extends OrientedShape3D {
	...
	private static final float[] verts = {
			...
			// 1.2f, 1.1f, 0.9f, 1.2f, -1.1f, 0.9f,
			// Right Face
			1.2f, -1.1f, 0.9f, 1.2f, 1.1f, 0.9f, 1.1f, 1.0f, 1.0f, 1.1f, -1.0f, 1.0f,
			// Left Face
			-1.1f, -1.0f, 1.0f, -1.1f, 1.0f, 1.0f, -1.2f, 1.1f, 0.9f, -1.2f, -1.1f, 0.9f,
			// Top Face
			1.1f, 1.0f, 1.0f, 1.2f, 1.1f, 0.9f, -1.2f, 1.1f, 0.9f, -1.1f, 1.0f, 1.0f,
			// Bottom Face
			-1.1f, -1.0f, 1.0f, -1.2f, -1.1f, 0.9f, 1.2f, -1.1f, 0.9f, 1.1f, -1.0f, 1.0f, };
	...
	private static final float[] normals = {
			...
			// Bottom Face
			0.0f, -1.0f, 1.0f, 0.0f, -1.0f, 1.0f, 0.0f, -1.0f, 1.0f, 0.0f, -1.0f, 1.0f, };
	private static final Point2f[] textureCoords = { new Point2f(1.0f, -0.5f), new Point2f(1.0f, 0.5f),
			new Point2f(0.0f, 0.5f), new Point2f(0.0f, -0.5f) };
	...
	QuadArray quadArray = new QuadArray(16, QuadArray.COORDINATES | QuadArray.NORMALS | QuadArray.TEXTURE_COORDINATE_2);
}
