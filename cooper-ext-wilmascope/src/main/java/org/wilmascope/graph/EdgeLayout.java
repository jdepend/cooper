 ...
 *          edges that can be placed by a LayoutEngine
 */
...
public abstract class EdgeLayout implements Layable, EdgeAbility {
	...
	/**
	 * Should be overridden (with a call to this super implementation) to load
	 * any properties from the node properties that are specific to the layout
	 * engine
	 */
