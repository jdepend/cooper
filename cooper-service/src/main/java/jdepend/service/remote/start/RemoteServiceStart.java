...
public final class RemoteServiceStart {
	...
	public synchronized void startService() throws JDependException {
		try {
			...
			JDependSessionService sessionService = ServiceFactory.createJDependSessionService();
			...
			AnalyzerService analyzerService = ServiceFactory.createAnalyzerService();
			...
			UserRemoteService userRemoteService = ServiceFactory.createUserRemoteService();
			...
			ScoreRemoteService scoreRemoteService = ServiceFactory.createScoreRemoteService();
