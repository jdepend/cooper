 ...
 * TupleSetListener, and ComponentListener and routes all the callbacks into a
 * generic {@link #update(Object)} method. For the case of ComponentListener,
 * only the resize event is funneled into the update method.
 * 
...
public abstract class UpdateListener implements ExpressionListener, TupleSetListener, ComponentListener {
	 ...
	 * 
	 * @param source
	 *            a source object, either the Expression, TupleSet, or Component
	 *            that triggered this update event.
	 */
	...
	/**
	 * @see prefuse.data.event.TupleSetListener#tupleSetChanged(prefuse.data.tuple.TupleSet,
	 *      prefuse.data.Tuple[], prefuse.data.Tuple[])
	 */
