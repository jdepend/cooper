...
/**
 * Swing widget which displays a preview image and helps select the scale for an
 * exported image.
 * 
...
public class ScaleSelector extends JComponent implements ChangeListener {
	...
	public class ImagePanel extends JComponent {
		...
		public void paintComponent(Graphics g) {
			...
			Image img = (scale == 1.0 ? image : image.getScaledInstance(w, h, Image.SCALE_DEFAULT));
			int x = (MAX_SIZE - w) / 2;
			int y = (MAX_SIZE - h) / 2;
