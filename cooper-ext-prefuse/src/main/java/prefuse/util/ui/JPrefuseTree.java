...
/**
 * Swing component that displays a prefuse Tree instance in a Swing JTree
 * component. Graph instances can also be displayed by first getting a Tree
 * instance with the {@link prefuse.data.Graph#getSpanningTree()} method.
 * 
...
public class JPrefuseTree extends JTree {
	 ...
	 *            the Tree to display
	 * @param labelField
	 *            the data field used to privde labels
	 */
	 ...
	 * field specified in the constructor of this class.
	 * 
	...
	public class PrefuseTreeModel implements TreeModel, GraphListener {
		...
		/**
		 * @see prefuse.data.event.GraphListener#graphChanged(prefuse.data.Graph,
	...
	/**
	 * Create a new window displaying the contents of the input Tree as a Swing
	 * JTree.
	 * 
	 * @param t
	 *            the Tree instance to display
	 * @param labelField
	 *            the data field to use for labeling nodes
