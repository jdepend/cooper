...
/**
 * TableModel implementation that serves as an adapter between a prefuse Table
 * instance and a JTable component.
 */
public class PrefuseTableModel implements TableModel, TableListener {
	...
	/**
	 * Initialize mapping between prefuse table rows and the rows reported by
	 * this model.
	 */
	 ...
	 * 
	 * @param rowIndex
	 *            the row index in this table model
