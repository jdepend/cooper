...
public class JToggleGroup extends JPanel {
	 ...
	 * 
	 * @param type
	 *            the toggle button type to use, one of {@link #CHECKBOX} or
	 *            {@link #RADIO}
	 * @param data
	 *            the list data that should populate the toggle group
	 */
	 ...
	 *            {@link #RADIO}
	 * @param data
	 *            the list model data backing the toggle group
	 */
	 ...
	 *            the list model data backing the toggle group
	 * @param selection
	 *            the list selection model to use to monitor selection changes
	 *            to the various toggle buttons.
	 */
	 ...
	 * 
	 * @param axis
	 *            the axis type, one of {@link javax.swing.BoxLayout#X_AXIS},
	 ...
	 * 
	 * @return the axis type, one of {@link javax.swing.BoxLayout#X_AXIS},
	 *         {@link javax.swing.BoxLayout#Y_AXIS},
	 *         {@link javax.swing.BoxLayout#LINE_AXIS}, or
	 *         {@link javax.swing.BoxLayout#PAGE_AXIS}.
	 */
	 ...
	 * 
	 * @param spacing
	 *            the spacing, in pixels, to use between components
	 */
	 ...
	 * 
	 * @param b
	 *            true to set toggle buttons keyboard accessible, false to set
	 *            them unaccessible.
	 */
