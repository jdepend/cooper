...
/**
 * Swing component that displays a prefuse Table instance in a Swing JTable
 * component.
 * 
...
public class JPrefuseTable extends JTable {
	...
	/**
	 * Create a new window displaying the contents of the input Table as a Swing
	 * JTable.
	 * 
	 * @param t
	 *            the Table instance to display
