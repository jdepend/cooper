 ...
 * range used by interface components and a richer range of values, such as
...
public interface ValuedRangeModel extends BoundedRangeModel {
	...
	/**
	 * Get the minimum value backing the range model. This is the absolute
	 * minimum value possible for the range span.
	 * 
	...
	/**
	 * Get the maximum value backing the range model. This is the absolute
	 * maximum value possible for the range span.
	 * 
