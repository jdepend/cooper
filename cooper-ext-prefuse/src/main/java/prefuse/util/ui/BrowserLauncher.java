...
/**
 * <p>
 * Browser launcher will open a URL in an external browser on your system. (e.g.
 * Internet Explorer or Netscape). If your browser is already open, a new
 * browser window should be created without starting any new processes.
 * </p>
 * 
 * <p>
 * On Windows systems the system's default browser will be used. On UNIX and
 * other platforms the browser defaults to Netscape. For this default behavior
 * to work, the command 'netscape' must be on your path.
 * </p>
 * 
 * <p>
 * This class was inspired by an article at www.javaworld.com by Steven Spencer.
 * The article is available at <a
 * href="http://www.javaworld.com/javaworld/javatips/jw-javatip66.html">
