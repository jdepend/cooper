...
/**
 * Swing component that contains a slider, and title label, and editable text
 * box displaying the slider value.
 * 
...
public class JValueSlider extends JComponent {
	 ...
	 * 
	 * @param title
	 *            the title label of the slider component
	 * @param min
	 *            the value associated with the minimum slider position
	 * @param max
	 *            the value associated with the maximum slider position
	 * @param value
	 *            the value associated with the starting slider position
	 */
