...
public class JSearchPanel extends JPanel implements DocumentListener, ActionListener {
	 ...
	 *            initiated by hitting the enter key (false)
	 */
	public JSearchPanel(TupleSet source, SearchTupleSet search, String[] fields, boolean autoIndex,
	 ...
	 *            initiated by hitting the enter key (false)
	 */
	public JSearchPanel(Visualization vis, String group, String searchGroup, String field, boolean autoIndex,
			boolean monitorKeystrokes) {
	 ...
	 *            initiated by hitting the enter key (false)
	 */
	public JSearchPanel(Visualization vis, String group, String searchGroup, String[] fields, boolean autoIndex,
			boolean monitorKeystrokes) {
		m_lock = vis;
		m_fields = fields;
		m_autoIndex = autoIndex;
	...
	public class CancelButton extends JComponent implements MouseListener {
		...
		private int[] outline = new int[] { 0, 0, 2, 0, 4, 2, 5, 2, 7, 0, 9, 0, 9, 2, 7, 4, 7, 5, 9, 7, 9, 9, 7, 9, 5,
				7, 4, 7, 2, 9, 0, 9, 0, 7, 2, 5, 2, 4, 0, 2, 0, 0 };
		...
		public void paintComponent(Graphics g) {
			...
			for (int i = 0; i + 3 < outline.length; i += 2) {
				g.drawLine(outline[i], outline[i + 1], outline[i + 2], outline[i + 3]);
			}
		}
