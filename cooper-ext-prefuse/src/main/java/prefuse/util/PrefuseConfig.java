...
/**
 * <p>
 * Runtime configuration settings for the prefuse framework. Maintains a set of
 * hardwired configuration settings that can be overrriden by creating a text
 * proeprties file containing custom values. By default, prefuse will look for
 * the file "prefuse.conf" in the current working directory for configuration
 * name/value pairs. The framework can be instructed to look for a different
 ...
 * asynchronous database worker threads. The default prefuse setting is 5 (same
 * as the Java thread default).</li>
 * <li><code>data.filter.optimizeThreshold</code> - the minimum number of items
 * that must be contained in a table for optimized query plans to be considered.
 * The default value is 300.</li>
 ...
 * properties. This class is a singleton, accessed through a static accessor
 * method.
 * </p>
 * 
...
public class PrefuseConfig extends Properties {
	 ...
	 * @param key
	 *            the name of the property to lookup
	 * @return the property value, or the minimum possible integer value if the
	 *         key is not found or parsing of the number fails.
	 */
	 ...
	 * @param key
	 *            the name of the property to lookup
	 * @return the property value, or the minimum possible long value if the key
	 *         is not found or parsing of the number fails.
	 */
	 ...
	 * @param key
	 *            the name of the property to lookup
	 * @return the property value, or a Float.NaN value if the key is not found
	 *         or parsing of the number fails.
	 */
	 ...
	 * @param key
	 *            the name of the property to lookup
	 * @return the property value, or a Double.NaN value if the key is not found
	 *         or parsing of the number fails.
	 */
	 ...
	 * @param key
	 *            the name of the property to lookup
	 * @return the property value. False is returned if the key is not found or
	 *         does not parse to a true/false value.
	 */
	...
	private void setDefaults() {
		...
		setProperty("data.io.worker.threadPriority", String.valueOf(Thread.NORM_PRIORITY));
