...
/**
 * Comparator that makes comparison using an ordered list of individual
 * comparators;
 * 
...
public class CompositeComparator implements Comparator {
	 ...
	 * 
	 * @param size
	 *            the starting capacity of this comparator
	 */
	 ...
	 * 
	 * @param cmp
	 *            the constituent comparators of this composite
	 */
	 ...
	 * @return true if the comparator was successfully removed, false otherwise
	 */
