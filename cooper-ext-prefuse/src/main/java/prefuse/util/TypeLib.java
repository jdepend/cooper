...
public class TypeLib {
	...
	/**
	 * Check if an object is an instance of a given class, or, if the class is a
	 * primitive type, if the Object is an instance of the wrapper class for
	 * that primitive (e.g., as Integer is a wrapper for int).
	 * 
	 * @param type
	 *            the Class type
	 * @param instance
	 *            the Object instance
	 * @return true if the object is an instance of the given class, or if of
	 *         the appropriate primitive wrapper type.
	 */
	 ...
	 * currently does not compute the actual least common ancestor, but only
	 * looks up one level in the inheritance tree and quits if it does not find
	 * a match.
	 * 
	 * @param o1
	 *            the first object
	 * @param o2
	 *            the second object
	 * @return the nearest class instance of which both objects are instances
	 */
	 ...
	 * @param type2
	 *            the second type
	 * @return the nearest class instance which is equal to or a superclass of
	 *         the two class instances
	 */
	 ...
	 * @param instance
	 *            the object to test as wrapper (e.g., as Integer is a wrapper
	 *            type for int)
	 * @return true if the object is a wrapper instance of the given primitive
	 *         type
	 */
	 ...
	 * @param type
	 *            a class type
	 * @return the wrapper class for the input type if it is a primitive class
	 *         type, otherwise returns the input type
	 */
	...
	/**
	 * Indicates if a given class type is a primitive integer type (one of byte,
	 * short, int, or long).
	 * 
	 * @param type
	 *            the type to check
	...
	/**
	 * Indicates if a given class type is a primitive numeric one type (one of
	...
	/**
	 * Get a compatible numeric type for two primitive numeric class types. Any
	 * of (byte, short, int) will resolve to int.
	 * 
	 * @param c1
