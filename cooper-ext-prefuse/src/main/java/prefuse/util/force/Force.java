...
public interface Force {
	...
	/**
	 * Returns the number of parameters (e.g., gravitational constant or spring
	 * force coefficient) affecting this force function.
	 * 
	 ...
	 *            the parameter index
	 * @param val
	 *            the suggested minimum value to use
	 */
	...
	/**
	 * Indicates if this force function will compute forces on ForceItem
	 * instances
	 * 
	 ...
	 * 
	 * @param item
	 *            the ForceItem on which to compute updated forces
	 */
