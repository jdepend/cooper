...
/**
 * Swing Action components that brings up a dialog allowing users to configure a
 * force simulation.
 * 
...
public class ForceConfigAction extends AbstractAction {
	 ...
	 * 
	 * @param frame
	 *            the parent frame for which to create the dialog
	 * @param fsim
	 *            the force simulator to configure
	 */
