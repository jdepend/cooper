...
/**
 * Updates velocity and position data using the 4th-Order Runge-Kutta method. It
 * is slower but more accurate than other techniques such as Euler's Method. The
 * technique requires re-evaluating forces 4 times for a given timestep.
 * 
