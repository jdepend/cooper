...
public class DataLib {
	...
	public static Object[] ordinalArray(Iterator tuples, String field) {
		return DataLib.ordinalArray(tuples, field, DefaultLiteralComparator.getInstance());
	}
	 ...
	 *            the column / data field name
	 * @param mean
	 *            the mean of the column, used to speed up accurate deviation
	 *            calculation
	 * @return the standard deviation value, or NaN if a non-numeric data type
	 *         is encountered
	 */
			...
			while (iter.hasNext()) {
				...
				if (type == null) {
					...
					if (type2.isAssignableFrom(type)) {
						...
						throw new IllegalArgumentException("The data field [" + field + "] does not have "
