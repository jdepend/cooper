...
/**
 * Library of supplementary array routines not supported by the java.util.Arrays
 * class.
 * 
 * @author jeffrey heer
 */
public abstract class ArrayLib {
	 ...
	 *            the array to shuffle
	 * @param start
	 *            the starting index of the range to shuffle
	 * @param len
	 *            then length of the range to shuffle
	 * @param r
	 *            the source of randomness to use
	 */
	 ...
	 * @param key
	 *            the key to search for
	 * @return the index of the first occurrence of the key in the array, of -1
	...
	/**
	 * Linearly search an array range for a given key value. Assumes that the
	 * range begins at index 0.
	 * 
	 * @param a
	 *            the array to search
	 * @param key
	 ...
	 * 
	 * @param a
	 *            the array to potentially resize
	 * @param size
	 ...
	 *            the array to trim
	 * @param size
	 *            the desired size of the array. This value must be lesser than
	 ...
	 *            array.
	 * @param abuf
	 *            a buffer array to perform the sorting without allocating any
	 *            additional memory
	 * @param bbuf
	 *            a buffer array to perform the sorting without allocating any
	 *            additional memory
