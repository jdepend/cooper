...
/**
 * A chain of Predicates and associated values, maintain a large if-statement
 * structure for looking up values based on a Predicate condition.
 * 
...
public class PredicateChain {
	 ...
	 * 
	 * @return the predicate chain, either an IfExpression or the single
	 *         terminal default Expression instance.
	 */
	 ...
	 * @param t
	 *            the Tuple
	 * @return the object associated with the first Predicate that successfully
	 *         matches the Tuple.
	 */
	...
	/**
	 * Add a new rule to the end of the chain, associating a Predicate condition
	...
	/**
	 * Remove rules using the given predicate from this predicate chain. This
	 * method will not remove rules in which this predicate is used within a
	 * composite of clauses, such as an AND or OR. It only removes rules using
	 * this predicate as the top-level trigger.
	 * 
	 * @param p
