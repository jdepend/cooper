...
public interface Renderer {
	...
	/**
	 * Provides a default graphics context for renderers to do useful things
	 * like compute string widths when an external graphics context has not yet
	 * been provided.
	 */
	public static final Graphics2D DEFAULT_GRAPHICS = (Graphics2D) new BufferedImage(1, 1, BufferedImage.TYPE_INT_ARGB)
			.getGraphics();
