...
public interface GraphListener extends EventListener {
	 ...
	 * 
	 * @param g
	 *            the graph that has changed
	 * @param table
	 *            the particular table within the graph that has changed
	 * @param start
	 *            the starting row index of the changed table region
	 * @param end
	 *            the ending row index of the changed table region
	 * @param col
	 *            the column that has changed, or
	 *            {@link EventConstants#ALL_COLUMNS} if the operation affects
	 *            all columns
	 * @param type
	 *            the type of modification, one of {@link EventConstants#INSERT}
