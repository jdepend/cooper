...
public interface ColumnListener extends EventListener {
	 ...
	 * @param type
	 *            One of {@link EventConstants#INSERT},
	 *            {@link EventConstants#DELETE}, or
	 *            {@link EventConstants#UPDATE}.
	 * @param start
	 *            the first column index that has been changed
	 * @param end
	 *            the last column index that has been changed
	 */
	 ...
	 *            the column that has changed
	 * @param idx
	 *            the column row index that has changed
	 * @param prev
