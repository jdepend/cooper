...
/**
 * GraphWriter instance that writes a graph file formatted using the GraphML
 ...
 * <code>boolean</code>, and <code>string</code>. An exception will be thrown if
 * a data type outside these allowed types is encountered.
 * </p>
 * 
...
public class GraphMLWriter extends AbstractGraphWriter {
	...
	public void writeGraph(Graph graph, OutputStream os) throws DataIOException {
		...
		printSchema(xml, Tokens.EDGE, es, new String[] { graph.getEdgeSourceField(), graph.getEdgeTargetField() });
		xml.println();
