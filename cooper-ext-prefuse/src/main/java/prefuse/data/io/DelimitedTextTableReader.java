...
/**
 * TableReader for delimited text files, such as tab-delimited or pipe-delimited
 * text files. Such files typically list one row of table data per line of the
 * file, using a designated character such as a tab (\t) or pipe (|) to
 * demarcate different data columns. This class allows you to select any regular
 * expression as the column delimiter.
 * 
...
public class DelimitedTextTableReader extends AbstractTextTableReader {
	 ...
	 *            a regular expression string indicating the delimiter to use to
