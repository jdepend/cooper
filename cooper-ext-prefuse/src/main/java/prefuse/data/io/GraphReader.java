...
/**
 * nterface for classes that read in Graph or Tree data from a particular file
 * format.
 * 
...
public interface GraphReader {
	...
	/**
	 * Read in a graph from the file at the given location. Though not required
	 * by this interface, the String is typically resolved using the
	 * {@link prefuse.util.io.IOLib#streamFromString(String)} method, allowing
	 * URLs, classpath references, and files on the file system to be accessed.
	 * 
	 * @param location
