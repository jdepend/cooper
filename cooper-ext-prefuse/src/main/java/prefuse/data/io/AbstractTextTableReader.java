...
/**
 * Abstract base class for TableReader instances that read in a table from a
 * textual data file.
 * 
...
public abstract class AbstractTextTableReader extends AbstractTableReader {
	 ...
	 * 
	 * @param parserFactory
	 *            the ParserFactory to use for parsing text strings into table
	 *            values.
	 */
	 ...
	 * 
	 * @param hasHeaderRow
	 *            true if the the data file includes a header row, false
	 *            otherwise.
	 */
	...
	/**
	 * Subclasses can override this to provide column names through a custom
	 * mechanism.
	 * 
	...
	/**
	 * Returns default column header names of the type "A", "B", ..., "Z", "AA",
	 * "AB", etc.
	 * 
	 * @param idx
	...
	/**
	 * Scans the input stream, making call backs for each encountered entry on
	 * the provided TextReadListener.
	 * 
	 * @param is
	 ...
	 */
	protected abstract void read(InputStream is, TableReadListener trl) throws IOException, DataParseException;
