...
/**
 * TableReader for fixed-width text files, that encode one row of table data per
 * line use a fixed number of characters for each data column. Reading such
...
public class FixedWidthTextTableReader extends AbstractTextTableReader {
	...
	/**
	 * Creates a new FixedWidthTextTableReader using the schema at the given
	 * location.
	 * 
	 * @param location
