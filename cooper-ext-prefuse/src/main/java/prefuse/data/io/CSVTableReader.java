 ...
 * 
 * For a more in-depth description of the CSV format, please see this <a
 * href="http://www.creativyst.com/Doc/Articles/CSV/CSV01.htm"> CSV reference
 * web page</a>.
 * 
				...
				if (!inRecord) {
					...
					if (inQuote == 1) {
						...
						if (Character.isWhitespace(c[i])) {
							...
							throw new IllegalStateException("Invalid data format. " + "Error at line " + lineno
									+ ", col " + i);
						} else if (c[i] != ',') {
							sbuf.append(c[i]);
						} else {
