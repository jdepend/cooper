...
public class LuceneSearcher {
	 ...
	 * 
	 * @param dir
	 *            the Lucene Directory indicating the search index to use.
	 */
	...
	/**
	 * Create a new LuceneSearcher using a specified search index location, a
	 * particular Document field to index, and given read/write status.
	 * 
	 * @param dir
	 *            the Lucene Directory indicating the search index to use.
	 * @param field
	 *            the Lucene Document field that should be indexed.
	 * @param readOnly
	 *            if this index is read-only or is writable.
	 */
	...
	/**
	 * Create a new LuceneSearcher using a specified search index location, a
	 * particular Document fields to index, and given read/write status.
	 * 
	 * @param dir
	 *            the Lucene Directory indicating the search index to use.
	 * @param fields
	 *            the Lucene Document fields that should be indexed.
	 * @param readOnly
	 *            if this index is read-only or is writable.
	 */
	 ...
	 *             if the query is not parsed successfully
	 * @throws IOException
	 *             if an input/ouput error occurs
	 * @throws IllegalStateException
	 *             if the searcher is in write mode
	 */
	public Hits search(String query) throws ParseException, IOException {
		if (m_readMode) {
			...
			throw new IllegalStateException("Searches can only be performed when "
	 ...
	 *            the Document to add
	 * @throws IllegalStateException
	 *             if the searcher is not in write mode
	 */
	public void addDocument(Document d) {
		if (!m_readMode) {
			...
			throw new IllegalStateException("Documents can not be added to the index unless"
					+ "the LuceneSearcher is not in read mode");
		}
	}

	/**
	 * Returns the Analyzer used to process text. See Lucene documentation for
	 * more details.
	 * 
	...
	/**
	 * Sets the Analyzer used to process text. See Lucene documentation for more
	 * details.
	 * 
	 * @param analyzer
	 *            the analyzer to set
	...
	/**
	 * Returns the indexed Document fields. These fields determine which fields
	 * are indexed as Documents are added and which fields are queried over when
	 * searches are issued.
	 * 
	...
	/**
	 * Sets the indexed Document fields. These fields determine which fields are
	 * indexed as Documents are added and which fields are queried over when
	 * searches are issued. param fields the indexed Document fields to use
	 */
	...
	/**
	 * Returns the Lucene IndexReader. See Lucene documentation for more
	 * details.
	 * 
	...
	/**
	 * Returns the Lucene IndexSearcher. See Lucene documentation for more
	 * details.
	 * 
