...
public class ObjectColumn extends AbstractColumn {
	 ...
	 * 
	 * @param type
	 *            the data type of Objects in this column
	 */
	 ...
	 * @param defaultValue
	 *            the default value for the column. If this value is cloneable,
	 *            it will be cloned when assigned as defaultValue, otherwise the
	 *            input reference will be used for every default value.
	 */
		...
		try {
			...
			if (defaultValue != null) {
				Logger.getLogger(getClass().getName()).fine(
						"Default value of type \"" + defaultValue.getClass().getName() + "\" is not "
