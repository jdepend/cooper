...
/**
 * Factory class for generating appropriate column instances. Used by Tables to
 * generate their columns.
 * 
...
public class ColumnFactory {
	 ...
	 *            the number of rows to include in the column
	 * @param nnz
	 *            the number of expected non-zero entries (NOTE: currently this
	...
	public static final Column getColumn(Class type, int nrows, int nnz, Object defaultValue) {
		...
		} else if (type == byte.class || type == short.class || type == char.class || type == void.class) {
	 ...
	 * 
	 * @param t
	 *            the table the column should be added to
	 * @param expr
