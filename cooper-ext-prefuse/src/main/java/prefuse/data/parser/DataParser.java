...
/**
 * Interface for data parsers, which parse data values from text Strings and
 * generated formatted text Strings for data values.
 * 
...
public interface DataParser {
	...
	/**
	 * Indicates if the given text string can be successfully parsed by this
	 * parser.
	 * 
	 * @param text
	 *            the text string to check for parsability
	 * @return true if the string can be successfully parsed into this parser's
	 ...
	 * @return the parsed data value, which will be an instance of the Class
