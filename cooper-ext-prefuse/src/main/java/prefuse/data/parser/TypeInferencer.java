...
/**
 * Infers the data types for a table of data by testing each value of the data
 * against a bank of parsers and eliminating candidate parsers that do not
 * successfully parse the data. This class leverages the mechanisms of
 * {@link ParserFactory}, but while that class only supports one data field at a
 * time, TypeInferencer maintains a collection of ParserFactory instances to
 * infer type for multiple data columns simultaneously.
 * 
...
public class TypeInferencer {
	...
	/**
	 * Create a new TypeInferencer using the default ParserFactory settings,
	 * thus the default parsers and parser ordering will be used.
	 */
	...
	/**
	 * Create a new TypeInferenced using the input ParserFactory as a template
	 * for the desired parsers to check and parser ordering to use.
	 * 
	 * @param template
	 *            the template ParserFactory to use for included parsers and
	 *            their precedence.
	 */
	 ...
	 * 
	 * @param column
	 *            the data column index of the sample
	 * @param value
	...
	/**
	 * Get the data type for the highest ranking candidate parser still in the
	 * running for the given column index.
	 * 
	 * @param column
