...
/**
 * DataParser instance that parses float values from a text string. Float values
 * can be explicitly coded for by using a 'f' at the end of a number. For
 * example "1.0" could parse as a double or a float, but "1.0f" will only parse
 * as a float.
 * 
