...
/**
 * Abstarct base class for a Literal Expression that evaluates to a constant
 * value.
 * 
...
public abstract class Literal extends AbstractExpression {
	...
	/**
	 * Evaluate the given tuple and data field and return the result as a new
	 * Literal instance.
	 * 
	 * @param t
	 *            the Tuple
	 ...
	 * @return a new Literal expression containing the value of the Tuple's data
	 *         field
	 */
	 ...
	 * @param val
	 *            the object value
	 * @return a new Literal expression containing the object value. The type is
	 *         assumed to be the value's concrete runtime type.
	 */
	 ...
	 * @return a new Literal expression containing the object value
	 */
