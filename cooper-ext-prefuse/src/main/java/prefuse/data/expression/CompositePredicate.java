...
/**
 * Abstract base class for Predicate instances that maintain one or more
 * sub-predicates (clauses).
 * 
...
public abstract class CompositePredicate extends AbstractPredicate {
	 ...
	 * 
	 * @param p
	 *            the new sole sub-predicate clause
	 */
	...
	/**
	 * Get a predicate instance just like this one but without the given
	 * predicate as a clause.
	 * 
	 * @param p
