...
public class IfExpression extends AbstractExpression {
	 ...
	 * 
	 * @param test
	 *            the predicate test for the if statement
	 * @param thenExpr
	 *            the expression to evaluate if the test predicate evaluates to
	 *            true
	 * @param elseExpr
	 *            the expression to evaluate if the test predicate evaluates to
	 *            false
	...
	public String toString() {
		return "IF " + m_test.toString() + " THEN " + m_then.toString() + " ELSE " + m_else.toString();
	}
