...
/**
 * <p>
 * TupleSet implementation for treating a collection of tuple sets as a single,
 * composite tuple set. This composite does not take overlap between contained
 * TupleSets into account.
 * </p>
 * 
 * <p>
 * The {@link TupleSet#addTuple(Tuple)} and {@link #setTuple(Tuple)} methods are
 * not supported by this class, and calling these methods will result in a
 * UnsupportedOperationException. Instead, use the add or set methods on the
 * desired non-composite tuple set.
 * </p>
 * 
...
public class CompositeTupleSet extends AbstractTupleSet {
	 ...
	 * 
	 * @param set
	 *            the TupleSet to check for containment
	 * @return true if the TupleSet is contained in this composite, false
	 *         otherwise
	 */
	 ...
	 * 
	 * @param name
	 *            the name of the TupleSet to get
	 ...
	 * 
	 * @param name
	 *            the name of the TupleSet to remove
	 ...
	 * All contained TupleSets remain members of this composite, but they have
	 * their data cleared.
	 * 
