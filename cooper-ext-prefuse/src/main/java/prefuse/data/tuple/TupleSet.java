...
/**
 * A collection of data tuples. This is the top level interface for all data
 * collections in the prefuse framework.
 * 
...
public interface TupleSet {
	...
	/**
	 * Add a Tuple to this TupleSet. This method is optional, and may result in
	 * an UnsupportedOperationException on some TupleSet implementations.
	 * 
	 * @param t
	 *            the Tuple add
	 ...
	 *         values copied from the input tuple, or may be the input Tuple
	 *         itself.
	 */
	public Tuple addTuple(Tuple t);

	/**
	 * Set the TupleSet contents to be a single Tuple. This method is optional,
	 * and may result in an UnsupportedOperationException on some TupleSet
	 * implementations.
	 * 
	 * @param t
	...
	/**
	 * Indicates if this TupleSet supports the addition of data columns to its
	 * contained Tuple instances.
	 * 
	 ...
	 * 
	 * @param s
	 *            the Schema of data columns to add to this TupleSet
	 */
	 ...
	 *            the type of the data field
	 * @param defaultValue
	 *            the defaultValue of the data field
	 */
	 ...
	 *            the name of the data field
	 * @param expr
	 *            an uncompiled expression in the prefuse expression language.
	 *            This will be compiled to a valid expression, and the results
	 *            of applying the expression to a Tuple will become the data
	 *            field value for that Tuple.
	 ...
	 *            the name of the data field
	 * @param expr
	 *            a compiled expression in the prefuse expression language. The
	...
	/**
	 * Return an iterator over the tuples in this tuple set, filtered by the
	 * given predicate.
	 * 
	 * @param filter
	 ...
	 *            predicate to apply to tuples in this set, only tuples for
	 *            which the predicate evaluates to true are included in the
	 *            iteration. If this value is null, no filtering will be
	 *            performed.
	 * @param sort
	...
	/**
	 * Add a listener to this tuple set that will be notified when tuples are
	 * added and removed from the set.
	 * 
	 * @param tsl
	 *            the TupleSetListener to add
	 */
	 ...
	 * 
	 * @param tsl
	 *            the TupleSetListener to remove
	 */
	...
	/**
	 * Add a PropertyChangeListener to be notified of changes to a specific
	 * property bound to this TupleSet.
	 * 
	 * @param key
	 *            the specific key for which to listen to properties changes
	 * @param lstnr
	 *            the PropertyChangeListener to add
	 */
	...
	/**
	 * Remove a PropertyChangeListener from this TupleSet for a specific bound
	 * property.
	 * 
	 * @param key
	 ...
	 * @return the client property value, or null if no value was found for the
	 *         given key.
	 */
