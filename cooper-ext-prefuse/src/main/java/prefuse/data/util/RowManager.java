...
/**
 * Manages the set of valid rows for a Table instance, maintains an index of the
 * available and occupied rows. RowManager instances are used internally by
 * Table instances.
 * 
...
public class RowManager {
	 ...
	 * @return true if the row is valid and in use by the Table, false if it is
	 *         an illegal value or is currently free
	 */
	...
	/**
	 * Add a new row to management. The lowest valued available row will be
	 * used.
	 * 
	 ...
	 * @return true if the row was successfully released, false if it was
	 *         already free or if the input is not a valid row index
	 */
	...
	/**
	 * Given Table row and column indices, return the corresponding row in the
	 * underlying data column. This is of use for CascadedTable instances, which
	 * may reveal only a limited set of a parent table's rows and so must map
	 * between table rows and the actual indices of the inherited data columns.
	 * 
	 * @param row
	 *            the table row
	 * @param col
	 *            the table column
	 * @return the row value for accessing the correct value of the referenced
	 *         data column.
	 */
	...
	/**
	 * Given a column row index and a table column index, return the table row
	 * corresponding to the column value. This is of use for CascadedTable
	 * instances, which may reveal only a limited set of a parent table's rows
	 * and so must map between table rows and the actual indices of the
	 * inherited data columns.
	 * 
	 * @param columnRow
	 *            the row of the underlying data column
	 * @param col
	 *            the table column
	 * @return the row value for the Table that corresponds to the given column
	 *         row
	 */
	 ...
	 * @return an iterator over column row indices corresponding to valid rows
	 *         of this RowManager
	 */
	 ...
	 *            the table column index
	 * @param reverse
	 *            indicates the direction to iterate over, true for reverse,
	 *            false for normal
	 * @return an iterator over column row indices corresponding to valid rows
	 *         of this RowManager
	 */
	 ...
	 * 
	 * @param rows
	 *            an iterator over table row indices
	 * @param col
	 *            the table column index
	 * @return an iterator over column row indices corresponding to valid rows
	 *         of this RowManager
	...
	/**
	 * Iterator over the indices into a given data column, mapped to from the
