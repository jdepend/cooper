...
/**
 * Represents an index over a column of data, allowing quick lookups by data
 * value and providing iterators over sorted ranges of data. For convenience,
 * there are index lookup methods for a variety of data types; which ones to use
 * depend on the data type of the column being indexed and calling a lookup
 * method for an incompatible data type could lead to an exception being thrown.
 * 
...
public interface Index {
	...
	public static final int TYPE_AII = TYPE_ASCENDING | TYPE_LEFT_INCLUSIVE | TYPE_RIGHT_INCLUSIVE;
	/** Composite flag for a descending, left and right inclusive range. */
	public static final int TYPE_DII = TYPE_DESCENDING | TYPE_LEFT_INCLUSIVE | TYPE_RIGHT_INCLUSIVE;
	/**
	 * Composite flag for an ascending, left exclusive, right inclusive range.
	 */
	public static final int TYPE_AEI = TYPE_ASCENDING | TYPE_LEFT_EXCLUSIVE | TYPE_RIGHT_INCLUSIVE;
	/**
	 * Composite flag for a descending, left exclusive, right inclusive range.
	 */
	public static final int TYPE_DEI = TYPE_DESCENDING | TYPE_LEFT_EXCLUSIVE | TYPE_RIGHT_INCLUSIVE;
	/**
	 * Composite flag for an ascending, left inclusive, right exclusive range.
	 */
	public static final int TYPE_AIE = TYPE_ASCENDING | TYPE_LEFT_INCLUSIVE | TYPE_RIGHT_EXCLUSIVE;
	/**
	 * Composite flag for a descending, left inclusive, right exclusive range.
	 */
	public static final int TYPE_DIE = TYPE_DESCENDING | TYPE_LEFT_INCLUSIVE | TYPE_RIGHT_EXCLUSIVE;
	/** Composite flag for an ascending, left and right exclusive range. */
	public static final int TYPE_AEE = TYPE_ASCENDING | TYPE_LEFT_EXCLUSIVE | TYPE_RIGHT_EXCLUSIVE;
	/** Composite flag for a descending, left and right exclusive range. */
	public static final int TYPE_DEE = TYPE_DESCENDING | TYPE_LEFT_EXCLUSIVE | TYPE_RIGHT_EXCLUSIVE;
	...
	/**
	 * Get the size of this index, the number of data value / row pairs
	 * included.
	 * 
	 ...
	 * 
	 * @param type
	 *            the sort type, one of {@link #TYPE_ASCENDING} or
	 ...
	 * @param type
	 *            the iteration type, one of the composite flags involving both
	 *            a sort order, and whether each bound of the range should
