...
/**
 * DynamicQueryBinding supporting queries based on a range of included data
 * values.
 * 
...
public class RangeQueryBinding extends DynamicQueryBinding {
	 ...
	 *            the data field (Table column) to query
	 * @param forceOrdinal
	 *            if true, forces all items in the range to be treated in
	 *            strictly ordinal fashion. That means that if the data is
	 *            numerical, the quantitative nature of the data will be ignored
	 *            and only the relative ordering of the numbers will matter. In
	 *            terms of mechanism, this entails that a
	 *            {@link ObjectRangeModel} and not a {@link NumberRangeModel}
	 *            will be used to represent the data. If the argument is false,
	 *            default inference mechanisms will be used.
	 */
	...
	/**
	 * Create a new range slider for interacting with the query, using the given
	 * orientation and direction.
	 * 
	 * @param orientation
	 *            the orientation (horizontal or vertical) of the slider (see
	 *            {@link prefuse.util.ui.JRangeSlider})
	 * @param direction
	 *            the direction (direction of data values) of the slider (see
	 *            {@link prefuse.util.ui.JRangeSlider})
	 * @return a {@link prefuse.util.ui.JRangeSlider} bound to this dynamic
	 *         query.
	 */
