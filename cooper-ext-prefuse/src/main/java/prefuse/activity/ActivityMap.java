 ...
 * 
 * <p>
 * For example, an Activity could be stored in the map using the method call
 * put("activity", activityRef). The Activity pointed to by activityRef could
 * then be subsequently scheduled using the method call run("activity").
 * Furthermore, the Activity referred to by the key "activity" could be changed
 * later by another call to put(), changing a visualization's behavior without
 * modifying any other application code.
 * </p>
 * 
...
public class ActivityMap {
	 ...
	 * 
	 * @param parent
	 *            The parent map to use. This map is referred to to resolve keys
	 *            that are not found within this, the child map.
	 */
	 ...
	 * 
	 * @param key
	 *            the key corresponding to a requested Activity instance
	...
	/**
	 * Runs the Activity corresponding to the given key with the ActivityManager
	 * to begin at the specified time.
	 * 
	 * @param key
	 *            the key corresponding to the Activity to run
	 * @param time
	 *            the start time at which to begin the Activity
	 ...
	 * immediately after the completion of the Activity corresponding to the
	 * beforeKey. This method has no scheduling effect on the Activity
	 * corresponding to the before key.
	 * 
	 * @param beforeKey
	 *            the key corresponding to the first Activity
	 * @param afterKey
	 *            the key corresponding to the Activity to be scheduled after
	 ...
	 * 
	 * @param key
	 *            the lookup key for the Activity to cancel
	 * @return the cancelled Activity, or null if no Activity was found for the
	 *         given key.
	 */
	 ...
	 * 
	 * @param key
	 *            the key to associate with the Activity
	 * @param activity
	...
	/**
	 * Removes a mapping from this ActivityMap. The parent map, if any, is not
	 ...
	 * This does not include any mappings in the parent map.
	 * 
	...
	/**
	 * Sets this ActivityMap's parent. null values are legal, and indicate this
	 * map has no parent.
	 * 
	 * @param parent
	 *            the new parent for this map, or null for no parent
	 */
	...
	/**
	 * Returns this ActivityMap's parent map. This method return null if this
	 * map has no parent.
	 * 
