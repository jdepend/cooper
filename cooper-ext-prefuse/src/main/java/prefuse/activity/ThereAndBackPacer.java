...
/**
 * Pacing function that maps the animation fraction f such that it ranges from 0
 * to 1 and then back to 0 again. This is useful for animations with periodic
 * activity.
 * 
