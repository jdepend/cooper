...
/**
 * A Pacer, or pacing function, maps one double value to another; they are used
 * to parameterize animation rates, where the input value f moves from 0 to 1
 * linearly, but the returned output can vary quite differently in response to
 * the input.
 * 
 * @version 1.0
