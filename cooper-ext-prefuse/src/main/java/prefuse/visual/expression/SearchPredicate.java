 ...
 * the type {@link prefuse.data.search.SearchTupleSet}, but including a possible
 * special case in which all items should be pass through the predicate if no
 * search query is specified. The data group name is provided by a String-valued
 * sub-expression.
 * 
