...
/**
 * Abstract base class for Expression instances dealing with data groups within
 * a Visualization. Maintains an Expression that serves as the paremter to this
 * Function; this Expression should return a valid group name when evaluated on
 * a given Tuple.
 * 
...
public abstract class GroupExpression extends AbstractExpression implements Function {
	 ...
	 * 
	 * @param t
	 *            the input Tuple to the group name expression
