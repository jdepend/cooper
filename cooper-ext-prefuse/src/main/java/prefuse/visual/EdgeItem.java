...
/**
 * VisualItem that represents an edge in a graph. This interface combines the
 * {@link VisualItem} interface with the {@link prefuse.data.Edge} interface.
 * 
...
public interface EdgeItem extends VisualItem, Edge {
	 ...
	 * 
	 * @param n
	 *            a NodeItem upon which this edge is incident. If this item is
	 *            not connected to this edge, a runtime exception will be
	 *            thrown.
