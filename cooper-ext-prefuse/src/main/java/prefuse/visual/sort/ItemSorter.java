...
/**
 * ItemSorter instances provide an integer score for each VisualItem; these
 * scores are then used to sort the items in ascending order of score.
 * ItemSorters are used to determine the rendering order of items in a Display.
 * 
...
public class ItemSorter implements Comparator {
	 ...
	 * @return -1 if score(v1) &lt; score(v2), 1 if score(v1) &gt; score(v2) and
	 *         0 if score(v1) == score(v2).
	 */
