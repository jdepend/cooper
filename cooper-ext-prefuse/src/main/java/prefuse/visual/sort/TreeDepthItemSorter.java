...
/**
 * ItemSorter that sorts items by tree depths. By default items deeper in the
 * tree are given lower scores, so that parent nodes are drawn on top of child
 * nodes. This ordering can be reversed using the appropriate constructor
 * arguments.
 * 
...
public class TreeDepthItemSorter extends ItemSorter {
	...
	/**
	 * Create a new TreeDepthItemSorter that orders nodes such that parents are
	 * placed above their children.
	 */
	 ...
	 * 
	 * @param childrenAbove
	 *            true if children should be ordered above their parents, false
	 *            if parents should be ordered above their children.
	 */
	...
	/**
	 * Score items similarly to {@link ItemSorter}, but additionally ranks items
	 * based on their tree depth.
	 * 
