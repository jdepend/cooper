...
/**
 * VisualTable instance that maintains visual items representing aggregates of
 * items. This class maintains both a collection of AggregateItems and a mapping
 * between AggregateItems and the VisualItems contained within those aggregates.
 * 
...
public class AggregateTable extends VisualTable {
	 ...
	 * 
	 * @param vis
	 *            the Visualization associated with the table
	 * @param group
	 ...
	 *            the data group the table contents belongs to
	 * @param schema
	 *            the Schema to use for this table
	 */
	...
	/**
	 * Get the size of the aggregate represented at the given table row. Returns
	 * the number of visual items contained in the aggregation.
	 * 
	 ...
	 * 
	 * @param row
	 *            the row index of the aggregate
	 * @param member
	 ...
	 *            the row index of the aggregate
	 * @param member
	 *            the item to remove from the aggregation
	 */
	 ...
	 * 
	 * @param row
	 *            the table row of the aggregate
	 * @param update
	 *            indicates whether or not to fire a table update
	 */
	 ...
	 *            the table row of the aggregate
	 * @param member
	 *            the item to check from containment
	...
	/**
	 * Get the row index to the aggregate mapping table for the given aggregate
	 * and contained VisualItem.
	 * 
	 * @param row
	 *            the table row of the aggregate
	 * @param member
	 *            the VisualItem to look up
	 ...
	 * 
	 * @param t
	 *            the tuple to compute the hash for
	 ...
	 *            indicates if an exception should be thrown when an invalid row
	 *            is encountered
