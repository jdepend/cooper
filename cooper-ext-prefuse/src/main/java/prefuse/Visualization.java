...
public class Visualization {
	 ...
	 */
	public synchronized VisualGraph addGraph(String group, Graph graph, Predicate filter, Schema nodeSchema,
			Schema edgeSchema) {
		...
		VisualGraph vg = new VisualGraph(nt, et, graph.isDirected(), graph.getNodeKeyField(),
	 ...
	 *            the data schema to use for the visual edge table
	 */
	public synchronized VisualTree addTree(String group, Tree tree, Predicate filter, Schema nodeSchema,
			Schema edgeSchema) {
		checkGroupExists(group); // check before adding sub-tables
		String ngroup = PrefuseLib.getGroupName(group, Graph.NODES);
		String egroup = PrefuseLib.getGroupName(group, Graph.EDGES);
		...
		VisualTree vt = new VisualTree(nt, et, tree.getNodeKeyField(), tree.getEdgeSourceField(),
