 ...
 * 
 * <p>
 * This implementation was ported from the implementation in the <a
 * href="http://jung.sourceforge.net/">JUNG</a> framework.
 * </p>
 * 
...
public class FruchtermanReingoldLayout extends Layout {
	...
	private void init(Graph g, Rectangle2D b) {
		...
		temp = b.getWidth() / 10;
		forceConstant = 0.75 * Math.sqrt(b.getHeight() * b.getWidth() / g.getNodeCount());
