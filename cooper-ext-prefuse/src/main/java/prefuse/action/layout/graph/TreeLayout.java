...
public abstract class TreeLayout extends Layout {
	 ...
	 *            instance, otherwise an exception will result when subclasses
	 *            attempt to retrieve the layout root.
	 */
	 ...
	 *            indicates that the root of the spanning tree of the backing
	 *            graph will be used as the layout root. If the node is not a
	 *            member of this layout's data group, an exception will be
	 *            thrown.
	 * @throws IllegalArgumentException
	 *             if the provided root is not a member of this layout's data
	 *             group.
	 */
	 ...
	 *             if the action's data group does not resolve to a
	 *             {@link prefuse.data.Graph} instance.
	 */
	public NodeItem getLayoutRoot() {
		...
		if (ts instanceof Graph) {
			...
			throw new IllegalStateException("This action's data group does" + "not resolve to a Graph instance.");
		}
	}
