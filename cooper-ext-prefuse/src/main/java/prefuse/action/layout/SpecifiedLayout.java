...
/**
 * Layout Action that sets x, y coordinates for a visual item by simply looking
 * them up from another data field.
 * 
...
public class SpecifiedLayout extends Layout {
	 ...
	 * @param xField
	 *            the field from which to lookup x coordinate values
	 * @param yField
	 *            the field from which to lookup y coordinate values
	 */
	 ...
	 * 
	 * @return the x-value field. If null, this action does not set the
	 *         x-coordiante.
	 */
	 ...
	 * 
	 * @param xField
	 *            the x-value field to use. If null, this action will not set
	 *            the x-coordiante.
	 */
	 ...
	 * 
	 * @return the y-value field. If null, this action does not set the
	 *         y-coordiante.
	 */
	 ...
	 * 
	 * @param yField
	 *            the y-value field to use. If null, this action will not set
	 *            the y-coordiante.
	 */
	 ...
	 * 
	 * @return the fixed field. If null, this action does not set the fixed
	 *         field.
	 */
	 ...
	 * 
	 * @param fixedField
	 *            the fixed field to use. If null, this action will not set the
	 *            fixed field.
	 */
