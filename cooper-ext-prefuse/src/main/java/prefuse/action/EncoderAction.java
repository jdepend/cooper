...
/**
 * ItemAction instance that can also maintain a collection of rule mappings that
 * can be used by subclasses to create particular rule-mappings for encoding
 * data values.
 * 
...
public abstract class EncoderAction extends ItemAction {
	 ...
	 * subclasses should crate public add methods of their own to enforce their
	...
	/**
	 * Remove rules using the given predicate from this encoder. This method
	 * will not remove rules in which this predicate is used within a composite
	 * of clauses, such as an AND or OR. It only removes rules using this
	 * predicate as the top-level trigger.
	 * 
	 * @param p
	 ...
	 * does nothing. Subclasses can override this method to perform custom setup
	 * before the Action is used.
	 */
	...
	/**
	 * Perform any necessary clean-up after this encoder can be used. By default
	 * does nothing. Subclasses can override this method to perform custom
	 * clean-up after the Action is used.
	 */
	...
	/**
	 * Calls the "setup" method for any delegate actions contained within the
	 * rule-mappings for this encoder.
	 */
