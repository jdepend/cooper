...
/**
 * The ActionSwitch selects between a set of Actions, allowing only one of a
 * group of Actions to be executed at a time.
 * 
 * @version 1.0
...
public class ActionSwitch extends CompositeAction {
	 ...
	 * 
	 * @param acts
	 *            the Actions to include in this switch
	 * @param switchVal
	 *            the switch value indicating which Action to run
	 */
	...
	/**
	 * Returns the current switch value, indicating the index of the Action that
	 * will be executed in reponse to run() invocations.
	 * 
