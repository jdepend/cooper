...
public class GraphDistanceFilter extends GroupAction {
	...
	/**
	 * Create a new GraphDistanceFilter that processes the given data group and
	 * uses a graph distance of 1. By default, the
	 * {@link prefuse.Visualization#FOCUS_ITEMS} group will be used as the
	 * source nodes from which to measure the distance.
	 * 
	 * @param group
	 *            the group to process. This group should resolve to a Graph
	 *            instance, otherwise exceptions will be thrown when this Action
	 *            is run.
	 */
	...
	/**
	 * Create a new GraphDistanceFilter that processes the given data group and
	 * uses the given graph distance. By default, the
	 * {@link prefuse.Visualization#FOCUS_ITEMS} group will be used as the
	 * source nodes from which to measure the distance.
	 * 
	 * @param group
	 ...
	 *            is run.
	 * @param sources
	 *            the group to use as source nodes for measuring graph distance.
	 * @param distance
	 *            the graph distance within which items will be visible.
	 */
