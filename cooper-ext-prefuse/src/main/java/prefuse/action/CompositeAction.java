...
/**
 * Abstract base class for Action implementations that hold a collection of
 * subclasses.
 * 
...
public abstract class CompositeAction extends Action {
	 ...
	 * 
	 * @param vis
	 *            the {@link prefuse.Visualization} processed by this Action
	 */
	...
	/**
	 * Creates a new CompositeAction of specified duration and default step time
	 * of 20 milliseconds.
	 * 
	 * @param duration
	...
	/**
	 * Creates a new CompositeAction of specified duration and default step time
	 * of 20 milliseconds that processes the given Visualization.
	 * 
	 * @param vis
	 *            the {@link prefuse.Visualization} processed by this Action
	 * @param duration
	 ...
	 * 
	 * @param i
	 *            the index at which to add the Action
	 * @param a
	 *            the Action instance to add
	 */
