...
/**
 * Animator that linearly interpolates between starting and ending colors for
 * VisualItems during an animation. By default, interpolates the three primary
 * color fields: {@link VisualItem#STROKECOLOR stroke color},
 * {@link VisualItem#FILLCOLOR fill color}, and {@link VisualItem#TEXTCOLOR text
 * color}.
 * 
...
public class ColorAnimator extends ItemAction {
	...
	private static final String[] DEFAULTS = new String[] { VisualItem.STROKECOLOR, VisualItem.FILLCOLOR,
	...
	/**
	 * Create a new ColorAnimator that processes the specified group and color
	 * field.
	 * 
	 * @param group
	 *            the data group to process
