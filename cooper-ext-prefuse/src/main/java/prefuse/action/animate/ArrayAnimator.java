...
public class ArrayAnimator extends ItemAction {
	...
	/**
	 * Create a new ArrayAnimator that processes the given data group and
	 * interpolates arrays in the given data field.
	 * 
	 * @param group
	 *            the data group to process
	 * @param field
	 *            the data field to interpolate. This should be an interpolated
	 *            field (have start and end instances as well as the field name
	 *            itself).
	 */
