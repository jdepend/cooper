 ...
 * during an animation. Font sizes are interpolated linearly. If the animation
 * fraction is under 0.5, the face and style of the starting font are used,
 * otherwise the face and style of the second font are applied.
 * 
