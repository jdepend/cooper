 ...
 * within other ActionList or {@link ActionSwitch} instances, allowing recursive
 * composition of different sets of Actions.
 * </p>
 * 
...
public class ActionList extends CompositeAction {
	...
	private static final Logger s_logger = Logger.getLogger(ActionList.class.getName());
	...
	/**
	 * Creates a new ActionList of specified duration and default step time of
	 * 20 milliseconds.
	 * 
	 * @param duration
	...
	/**
	 * Creates a new ActionList which processes the given Visualization and has
	 * the specified duration and a default step time of 20 milliseconds.
	 * 
	 * @param vis
	 *            the {@link prefuse.Visualization} to process.
	 * @param duration
	 ...
	 *            the duration of this Activity, in milliseconds
	 * @param stepTime
	 *            the time to wait in milliseconds between executions of the
	 *            action list
	 */
