...
public class FloatIntTreeMapTest extends TestCase {
	...
	/*
	 * Test method for
	 * 'edu.berkeley.guir.prefuse.data.util.IntIntTreeMap.clear()'
	 */
	...
	/*
	 * Test method for
	 * 'edu.berkeley.guir.prefuse.data.util.IntIntTreeMap.get(int)'
	 */
	public void testGet() {
	...
	/*
	 * Test method for
	 * 'edu.berkeley.guir.prefuse.data.util.IntIntTreeMap.put(int, int)'
	 */
	public void testPut() {
		map.clear();
		int size = 0;
	...
	/*
	 * Test method for
	 * 'edu.berkeley.guir.prefuse.data.util.IntIntTreeMap.remove(int)'
	 */
	...
	/*
	 * Test method for
	 * 'edu.berkeley.guir.prefuse.data.util.IntIntTreeMap.firstKey()'
	 */
	...
	/*
	 * Test method for
	 * 'edu.berkeley.guir.prefuse.data.util.IntIntTreeMap.lastKey()'
	 */
	...
	/*
	 * Test method for
	 * 'edu.berkeley.guir.prefuse.data.util.IntIntTreeMap.subMap(int, int)'
	 */
	...
	/*
	 * Test method for
	 * 'edu.berkeley.guir.prefuse.data.util.AbstractTreeMap.size()'
	 */
	...
	/*
	 * Test method for
	 * 'edu.berkeley.guir.prefuse.data.util.AbstractTreeMap.isEmpty()'
	 */
	...
	/*
	 * Test method for
	 * 'edu.berkeley.guir.prefuse.data.util.AbstractTreeMap.valueIterator()'
	 */
