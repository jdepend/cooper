...
public class TableTest extends TestCase implements TableTestData {
	...
	/*
	 * Test method for
	 * 'edu.berkeley.guir.prefuse.data.Table.getColumnClass(int)'
	 */
	...
	/*
	 * Test method for
	 * 'edu.berkeley.guir.prefuse.data.Table.getColumnClass(String)'
	 */
	...
	/*
	 * Test method for
	 * 'edu.berkeley.guir.prefuse.data.Table.getColumnIndex(String)'
	 */
	...
	/*
	 * Test method for 'edu.berkeley.guir.prefuse.data.Table.addColumn(String,
	 * Class)'
	 */
	...
	/*
	 * Test method for
	 * 'edu.berkeley.guir.prefuse.data.Table.removeColumn(String)'
	 */
	...
	/*
	 * Test method for 'edu.berkeley.guir.prefuse.data.Table.canGet(String,
	 * Class)'
	 */
	...
	/*
	 * Test method for 'edu.berkeley.guir.prefuse.data.Table.canSet(String,
	 * Class)'
	 */
	...
	/*
	 * Test method for 'edu.berkeley.guir.prefuse.data.Table.set(Object, String,
	 * int)'
	 */
	public void testSet() {
		for (int c = 0; c < NCOLS; ++c) {
