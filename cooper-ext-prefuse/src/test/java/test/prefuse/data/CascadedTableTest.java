...
public class CascadedTableTest extends TestCase implements TableTestData {
	...
	public void testCascadedTableRangeFilters() {
		...
		Expression xhi = new ArithmeticExpression(ArithmeticExpression.ADD, xhi1, xhi2);

		ComparisonPredicate idCmp = new ComparisonPredicate(ComparisonPredicate.GTEQ, id, x0);
		RangePredicate dubRg = new RangePredicate(RangePredicate.IN_EX, dub, xlo, xhi);
