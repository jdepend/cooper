...
public class VisualAggregateTableTest extends TestCase {
	...
	/*
	 * Test method for 'prefuse.data.tuple.AggregateTable.addToAggregate(int,
	 * Tuple)'
	 */
	...
	/*
	 * Test method for
	 * 'prefuse.data.tuple.AggregateTable.removeFromAggregate(int, Tuple)'
	 */
	...
	/*
	 * Test method for
	 * 'prefuse.data.tuple.AggregateTable.removeAllFromAggregate(int)'
	 */
	...
	/*
	 * Test method for 'prefuse.data.tuple.AggregateTable.aggregateContains(int,
	 * Tuple)'
	 */
