...
/**
 * A simple scatter plot visualization that allows visual encodings to be
 * changed at runtime.
 * 
...
public class ScatterPlot extends Display {
	...
	private static JToolBar getEncodingToolbar(final ScatterPlot sp, final String xfield, final String yfield,
			final String sfield) {
		int spacing = 10;
