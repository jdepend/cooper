...
/**
 * <p>
 * A prefuse-based implementation of Fisheye Menus, showcasing the use of visual
 * distortion to provide access to a large number of data items without
 * scrolling.
 * </p>
 * 
 * <p>
 * This implementation is inspired by the Fisheye Menu research conducted by Ben
 * Bederson at the University of Maryland. See the <a
 * href="http://www.cs.umd.edu/hcil/fisheyemenu/">Fisheye Menu project web
...
public class FisheyeMenu extends Display {
	...
	/**
	 * This schema holds the data representation for internal storage of menu
	 * items.
	 */
	 ...
	 * 
	 * @param name
	 *            the menu label to use
	 * @param action
	 *            the ActionListener to notify when the item is clicked The
	 *            prefuse VisualItem corresponding to this menu item will be
	 *            returned by the ActionEvent's getSource() method.
	 */
