...
public class RadialGraphView extends Display {
	...
	public static final String DATA_FILE = "/socialnet2.xml";
	...
	public RadialGraphView(Graph g, String label) {
		...
		FontAction fonts = new FontAction(treeNodes, FontLib.getFont("����", 15));
	...
	public static JPanel demo(Graph g, final String label) {
		...
		search.setFont(FontLib.getFont("����", Font.PLAIN, 16));
