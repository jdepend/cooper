...
/**
 * The <code>DependTreeModel</code> class defines the data model being observed
 * by a <code>DependTree</code> instance.
 * 
 * @author <b>Abner</b>
 * 
 */
...
public class DependTreeModel implements TreeModel {
	...
	/**
	 * Constructs a <code>DependTreeModel</code> with the specified root package
	 * node.
	 * 
	 * @param root
	 *            Root package node.
